...
class DoneFragment(
    ...
    private fun initView(){
        ...
        mainActivity.routineViewModel.routineLivData.observe(mainActivity, Observer {
            ...
            //데이터 수 갱신
            mainActivity.routineViewModel.currentRoutineDataNum.value!![1] = routineListAdapter.itemCount
        })
        ...
        mainActivity.taskViewModel.taskLiveData.observe(mainActivity, Observer {
            ...
            //데이터 수 갱신
            mainActivity.taskViewModel.currentTaskDataNum.value!![1] = taskListAdapter.itemCount
        })
